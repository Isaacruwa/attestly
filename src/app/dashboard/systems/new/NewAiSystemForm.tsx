...
// Extracted from page.tsx so useSearchParams (needed to read the ?org=
// param for agency/multi-client creation) can be wrapped in a Suspense
// boundary at the page level, per Next.js App Router requirements.
export default function NewAiSystemForm() {
